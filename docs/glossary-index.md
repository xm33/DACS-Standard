...
| AttestationRef | [§B.5](../spec/SPECIFICATION.md#b5-shared-phase-handler-types) | Reference to anchored evidence plus content hash. |
| BundleParty | [§10.4](../spec/SPECIFICATION.md#104-attestation-bundle) | Party entry inside an AttestationBundle. |
| Canonical form | [§B.7](../spec/SPECIFICATION.md#b7-universal-signature-scheme-domain-separated-signing) | RFC 8785 / JCS form used for hashes and signatures. |
| ClaimReference | [§B.1](../spec/SPECIFICATION.md#b1-claim-references-and-identity) | Canonical identifier format for identity claims. |
